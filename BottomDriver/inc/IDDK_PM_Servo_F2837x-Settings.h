...
//#define RS      2.4                   // Stator resistance (ohm) - макет
#define RS   0.47                       //немец 70
#define RR      0                       // Rotor resistance (ohm)
//#define LS    0.000230                  // Stator inductance (H) - макет
#define LS      0.0017                  // Stator inductance (H)
//#define LS     0.008                   //немец 70
#define LR      0                       // Rotor inductance (H)
#define LM      0                       // Magnetizing inductance (H)
//#define POLES     8                    // Number of poles - макет
#define POLES     10                  //немец 70
